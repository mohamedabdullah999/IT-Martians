...
@section('content')
    ...
    <section class="cosmic-bg py-40 text-center px-4 border-b border-purple-900/50">
        ...
        <div class="absolute top-32 right-[10%] text-5xl md:text-7xl animate-float opacity-80 pointer-events-none drop-shadow-2xl">🚀</div>
        <div class="absolute bottom-24 left-[15%] text-5xl md:text-6xl animate-float-delayed opacity-80 pointer-events-none drop-shadow-2xl">🛸</div>
        <div class="absolute top-1/4 left-1/4 text-2xl animate-float opacity-40 text-white pointer-events-none">✨</div>
        <div class="absolute bottom-1/3 right-1/3 text-3xl animate-float-delayed opacity-40 text-white pointer-events-none">⭐</div>
    ...
    <section id="about" class="py-24 deep-space-bg relative overflow-hidden" data-animate>
        <div class="absolute -left-40 top-20 w-96 h-96 bg-purple-900/20 rounded-full blur-[100px] pointer-events-none"></div>
        <div class="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
            ...
            <div class="aspect-video rounded-3xl overflow-hidden shadow-[0_0_30px_rgba(168,85,247,0.15)] relative border border-purple-500/30 group bg-[#0a0f25]">
                @if(!empty($settings['about_video_url']))
                    ...
                    @endphp
                    <iframe class="w-full h-full" src="{{ $embedUrl }}" title="فيديو تعريفي" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                @else
                    <img src="{{ asset($settings['about_image'] ?? 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80') }}" alt="بيئة عمل تقنية" class="w-full h-full object-cover opacity-80 transition-transform duration-1000 group-hover:scale-105 group-hover:opacity-100">
                    <div class="absolute inset-0 bg-[#050B14] bg-opacity-50 flex items-center justify-center transition-opacity duration-500 group-hover:bg-opacity-30 cursor-pointer">
    ...
    <section class="py-20 bg-gradient-to-r from-[#16123D] to-[#050B14] text-white border-y border-white/5 relative" data-animate>
    ...
    <section id="services" class="py-24 nebula-bg overflow-hidden" data-animate>
        <div class="container mx-auto px-4 mb-16 relative">
    ...
    <section id="products" class="py-24 deep-space-bg overflow-hidden border-t border-white/5" data-animate>
    ...
    <section id="partners" class="py-16 nebula-bg shadow-inner overflow-hidden border-t border-white/5" data-animate>
    ...
    <section id="contact" class="py-24 deep-space-bg relative overflow-hidden border-t border-white/5" data-animate>
        <div class="absolute right-0 bottom-0 w-96 h-96 bg-red-900/20 rounded-full blur-[120px] pointer-events-none"></div>
